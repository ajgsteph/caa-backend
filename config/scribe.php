...
return [
  ...
  'title' => 'CAA — API Documentation',

  // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
  'description' => 'API REST de la plateforme CAA (Certificat Authenticité Artiste) — gestion des artistes, œuvres, certificats numériques et vérification publique.',
  ...
  'intro_text' => <<<'INTRO'
            ...
            <aside>Utilisez le bouton "Try it out" pour tester directement les endpoints depuis votre navigateur.</aside>
        INTRO,

  // The base URL displayed in the docs.
  // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
'base_url' => env('APP_URL', 'https://api.certifa.art'),
  ...
  'auth' => [
    ...
    'extra_info' => 'Obtenez votre token via `POST /api/v1/auth/login`. Envoyez-le ensuite dans l\'en-tête `Authorization: Bearer <token>`.',
  ],
